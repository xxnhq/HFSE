...
def main():
    ...
    parser.add_argument("--input_wavs_dir", default="/data2/DNS-Challenge/datasets/clean")
    parser.add_argument("--input_mels_dir", default="ft_dataset")
    parser.add_argument(
        "--input_training_file", default="filelists/LibriTTS/data_split_train.txt"
    )
    parser.add_argument(
        "--input_validation_file", default="filelists/LibriTTS/data_split_val.txt"
    )

    parser.add_argument(
        "--list_input_unseen_wavs_dir",
        nargs="+",
        default=["/data2/DNS-Challenge/datasets/clean"],
    )
    parser.add_argument(
        "--list_input_unseen_validation_file",
        nargs="+",
        default=["filelists/LibriTTS/data_split_test.txt"],
    )

    parser.add_argument("--checkpoint_path", default="exp/bigvgan")
    parser.add_argument("--config", default="configs/bigvgan_v2_16khz_80band_256x.json")
